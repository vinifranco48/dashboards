...
def concorr():
    ...
    st.markdown("""
        <h1 style="text-align: center; font-size: 2.5em; color: #000000;">Dashboard - Yamaha</h1>
    """, unsafe_allow_html=True)

    st.markdown("""
        <div style="display: flex; justify-content: center; align-items: center; margin-top: 20px;">
            <iframe title="carros" width="90%" height="800" 
                    src="https://app.powerbi.com/view?r=eyJrIjoiZmUyNWM4ZjktOGVkOS00MTFjLWJjMzQtYmEwOGVhZGY1ZWFiIiwidCI6ImMxOTIyMjIwLTgwMjYtNGNhNi04MmU0LWY5MDI0M2YxNTI0MiJ9" 
